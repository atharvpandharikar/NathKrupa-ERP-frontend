...
import { Home, CreditCard, Banknote, Calculator, BarChart3, Settings, Moon, Sun, LogOut, User as UserIcon, Laptop, Receipt, TrendingUp, TrendingDown } from "lucide-react";
...
const financeNavItems: NavItem[] = [
    { title: "Dashboard", url: "/finance/dashboard", icon: Home },
    { title: "Accounts", url: "/finance/accounts", icon: CreditCard },
    ...
    return (
        <div className="flex h-full flex-col">
            <div className="flex-1 min-h-0 px-2 py-2 space-y-3 overflow-y-auto pr-1">
                {/* Finance Navigation */}
                <div>{renderNavItems(financeNavItems)}</div>
